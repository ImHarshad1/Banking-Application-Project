...
import com.Bank.HDFC.repository.UserRepository;
...
public class UserServiceImpl implements UserService{
	...
	public BankResponse createAccount(UserRequest userRequest) {
		//Creating a account -saving a new user into the db
    ...
    public BankResponse debitAccount(CreditDebitRequest request) {
        ...
        if (availableBalance.intValue() < debitAmount.intValue()){
            ...
            return BankResponse.builder()
                    ...
                    .accountInfo(AccountInfo.builder()
                            .accountNumber(request.getAccountNumber())
                            .accountName(userToDebit.getLastName() + " " + userToDebit.getLastName() + " " + userToDebit.getOtherName())
    ...
    public BankResponse transfer(TransferRequest request) {
        ...
        EmailDetails debitAlert = EmailDetails.builder()
                ...
                .messageBody("The sum of " + request.getAmount() + " hase been deducted from your account! Your current balance is " + sourceAccountUser.getAccountBalance())
                .build();
